...
diff_match_patch.prototype.diff_prettyHtml = function(a) {
    for (var b = [], c = /&/g, d = /</g, e = />/g, f = /\n/g, g = 0; g < a.length; g++) {
        var h = a[g][0],
            l = a[g][1].replace(c, "&amp;").replace(d, "&lt;").replace(e, "&gt;").replace(f, "<br>");
        switch (h) {
            case DIFF_INSERT:
                b[g] = '<ins style="background:#93ff93;">' + l + "</ins>";
                break;
            case DIFF_DELETE:
                b[g] = '<del style="background:#ffb8b8;">' + l + "</del>";
                break;
            case DIFF_EQUAL:
                b[g] = "<span class='text-muted'>" + l + "</span>"
        }
    }
    return b.join("")
};
